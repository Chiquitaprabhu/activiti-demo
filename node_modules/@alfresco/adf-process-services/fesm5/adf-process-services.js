...
import { Injectable, NgModule, Component, EventEmitter, Input, Output, ViewChild, ViewEncapsulation, ContentChild, Directive, TemplateRef, Inject, NgZone, defineInjectable, inject } from '@angular/core';
import { FormBuilder, Validators, FormControl, FormsModule, ReactiveFormsModule } from '@angular/forms';
import { AlfrescoApiService, ContentService, ThumbnailService, EmptyListComponent, CommentProcessService, AppsProcessService, TranslationService, CustomEmptyContentTemplateDirective, LogService, AppConfigService, CardViewDateItemModel, CardViewTextItemModel, UserPreferencesService, UserPreferenceValues, FormFieldModel, FormModel, PeopleProcessService, UserProcessModel, AuthenticationService, CardViewUpdateService, FormService, DataColumnListComponent, TRANSLATION_PROVIDER, CoreModule, ProcessContentService, FormOutcomeModel, WidgetVisibilityService, FormRenderingService, EcmModelService, FormEvent, FormErrorEvent, FormOutcomeEvent, NodeService, FormBaseComponent, AppConfigValues, ActivitiContentService, PaginationComponent, CustomLoadingContentTemplateDirective, DataTableSchema, MOMENT_DATE_FORMATS, MomentDateAdapter, CardViewMapItemModel, BpmUserService, UploadService, UploadWidgetComponent, NodesApiService, WidgetComponent, SitesService, SearchService, ExternalAlfrescoApiService } from '@alfresco/adf-core';
