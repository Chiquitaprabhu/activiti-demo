...
import { AlfrescoApiService, CommentProcessService, AppsProcessService, TranslationService, CustomEmptyContentTemplateDirective, ContentService, LogService, UserPreferencesService, UserPreferenceValues, FormFieldModel, FormModel, PeopleProcessService, UserProcessModel, AuthenticationService, CardViewUpdateService, FormService, DataTableSchema, CustomLoadingContentTemplateDirective, AppConfigService, PaginationComponent, CardViewDateItemModel, CardViewTextItemModel, UploadService, ThumbnailService, EmptyListComponent, DataColumnListComponent, TRANSLATION_PROVIDER, CoreModule, FormOutcomeModel, WidgetVisibilityService, FormRenderingService, FormBaseComponent, EcmModelService, FormEvent, FormErrorEvent, FormOutcomeEvent, NodeService, MOMENT_DATE_FORMATS, MomentDateAdapter, CardViewMapItemModel, BpmUserService, AppConfigValues, ActivitiContentService, ProcessContentService, WidgetComponent, NodesApiService, SitesService, SearchService, ExternalAlfrescoApiService, UploadWidgetComponent } from '@alfresco/adf-core';
