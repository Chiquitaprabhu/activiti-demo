...
/*!
     ...
     */var a={"default":"default",button:"button",separator:"separator",menu:"menu",custom:"custom"};function p(t,e){if(!t)return undefined;var n=e.split(".");e="";do{var o=t[e+=n.shift()];o===undefined||"object"!=typeof o&&n.length?n.length?e+=".":t=undefined:(t=o,e="")}while(n.length);return t}function f(t){return!t.disabled}function l(t,e){return(t.order===undefined?Number.MAX_SAFE_INTEGER:t.order)-(e.order===undefined?Number.MAX_SAFE_INTEGER:e.order)}function d(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e];var n={};return t.forEach(function(e){Object.keys(e).forEach(function(t){t.startsWith("$")||(t in n&&Array.isArray(n[t])?n[t]=h(n[t],e[t]):t in n&&"object"==typeof n[t]?n[t]=d(n[t],e[t]):n[t]=e[t])})}),n}function h(t,e){var o=[],r={};return(t||[]).forEach(function(t){var e=t;e&&e.hasOwnProperty("id")?r[e.id]=e:o.push(e)}),(e||[]).forEach(function(t){var e=t;if(e&&e.hasOwnProperty("id")&&r[e.id]){var n=d(r[e.id],e);r[e.id]=n}else o.push(e)}),Object.keys(r).map(function(t){return r[t]}).concat(o)}var y=function(){function t(t){this.http=t}return t.prototype.load=function(t,i,s){var a=this;return new Promise(function(r){a.loadConfig(t,0).then(function(n){if(n){var o=n.config,t=sessionStorage.getItem("app.extension.config");if(t&&(o=JSON.parse(t)),o.$references&&0<o.$references.length){var e=o.$references.map(function(t,e){return a.loadConfig(i+"/"+t,e)});Promise.all(e).then(function(t){var e=t.filter(function(t){return t}).sort(l).map(function(t){return t.config});s&&0<s.length&&e.push.apply(e,u(s)),0<e.length&&(o=d.apply(void 0,u([o],e))),o=c({},o,a.getMetadata(n.config),{$references:e.map(function(t){return a.getMetadata(t)})}),r(o)})}else r(o)}})})},t.prototype.getMetadata=function(e){var n={};return Object.keys(e).filter(function(t){return t.startsWith("$")}).forEach(function(t){n[t]=e[t]}),n},t.prototype.loadConfig=function(t,n){var o=this;return new Promise(function(e){o.http.get(t).subscribe(function(t){e({order:n,config:t})},function(){e(null)})})},t.prototype.getElements=function(t,e,n){return void 0===n&&(n=[]),(p(t,e)||n||[]).filter(f).sort(l)},t.prototype.getContentActions=function(t,e){return this.getElements(t,e).map(this.setActionDefaults)},t.prototype.getRules=function(t){return t&&t.rules?t.rules:[]},t.prototype.getRoutes=function(t){return t&&t.routes||[]},t.prototype.getActions=function(t){return t&&t.actions||[]},t.prototype.getFeatures=function(t){return t&&t.features||[]},t.prototype.setActionDefaults=function(t){return t&&(t.type=t.type||a["default"],t.icon=t.icon||"extension"),t},t.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],t.ctorParameters=function(){return[{type:e.HttpClient}]},t.ngInjectableDef=n.defineInjectable({factory:function(){return new t(n.inject(e.HttpClient))},token:t,providedIn:"root"}),t}();
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
function O(t){return function(){return t.load()}}var S=function(){function t(){}return t.forRoot=function(){return{ngModule:t,providers:[{provide:n.APP_INITIALIZER,useFactory:O,deps:[j],multi:!0}]}},t.forChild=function(){return{ngModule:t}},t.decorators=[{type:n.NgModule,args:[{declarations:[C,x,w,E],exports:[C,x,w,E]}]}],t}(),P=function D(){};t.ExtensionsModule=S,t.ContentActionType=a,t.getValue=p,t.filterEnabled=f,t.sortByOrder=l,t.reduceSeparators=function F(t,e,n,o){if(0===n&&o[n].type===a.separator)return t;if(0<n){if(o[n-1].type===a.separator&&e.type===a.separator)return t;if(n===o.length-1&&e.type===a.separator)return t}return t.concat(e)},t.reduceEmptyMenus=function A(t,e){return e.type===a.menu&&0===(e.children||[]).length?t:t.concat(e)},t.mergeObjects=d,t.mergeArrays=h,t.RuleRef=P,t.ExtensionLoaderService=y,t.ExtensionService=b,t.ComponentRegisterService=I,t.AppExtensionService=j,t.RuleService=R,t.PreviewExtensionComponent=E,t.DynamicColumnComponent=w,t.DynamicExtensionComponent=C,t.DynamicTabComponent=x,t.ɵa=O,Object.defineProperty(t,"__esModule",{value:!0})});
